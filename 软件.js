...
const APPS = {
    video: {
        ...
        notice: "",
        updates: [
            { version: "v2.8.0 （补丁）", date: "2026-08-23", content: "·修复手机端反调试bug\n·新增网站标签栏显示网站图标" },
            { version: "v2.8.0", date: "2026-08-13", content: "1.更新假期活动，现在进入网站观影超过20分钟解锁其他接口，观看60分钟解锁所有接口\n2.新增观看历史和协议（使用软件默认通用软件使用协议）\n3.能随时看见观影累计时长\n4.更新接口保护机制（加密了接口防止被调用）\n5.计划更新*修改接口名字方便大家的使用\n6.比较高级的更新：使用最新反调试技术以及重要内容加密技术，禁止了网页端的右键功能" },
